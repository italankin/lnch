...
import com.italankin.lnch.feature.home.apps.popup.AdditionalSettingsPopupFragment;
...
import com.italankin.lnch.model.ui.LabelDescriptorUi;
...
public class AppsFragment extends AppFragment implements IntentQueue.OnIntentAction,
    ...
    public void onStart() {
        ...
        searchOverlayBehavior.setRequireNewGestureAtTop(
                preferences.get(Preferences.SEARCH_BAR_PULL_BEHAVIOR) == Preferences.SearchBarPullBehavior.NEW_GESTURE);
